...
const root=process.cwd(), folders=['src/engines','src/core','src/components/layout','src/pages/[country]']; const banned=/from ['"][^'"]*(don-det|pakse|laos|sri-lanka|thailand)[^'"]*['"]|['"]\/(laos|thailand|sri-lanka)(\/|['"])/i;
