...
assert.match(engine, /getEditorialFaq\(thing\.id\)/, 'Field Card engine must expose canonical FAQ editorial content');
...
assert.match(engine, /completeFaq\(getEditorialFaq\(thing\.id\)\)/, 'Canonical FAQ content must take precedence over generated FAQ content');
