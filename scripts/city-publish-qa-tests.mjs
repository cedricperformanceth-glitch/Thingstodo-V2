...
function place(id, category = 'restaurants') {
  return {
    ...
    shortDescription: 'A friendly verified address with a simple local character and enough practical context for travellers deciding where to stop.',
    media: { card: {} },
    spaCard: { handwrittenTags: ['Local stop', 'Easy visit', 'Daytime'], ...missingPhoto },
...
function thing(index) {
  ...
  return {
    ...
    coordinates: { latitude: 14, longitude: 105 },
    shortDescription: 'A verified local activity that gives travellers a clear idea of what they will do without adding unsupported promises or hype.',
    media: { card: {} },
    spaCard: { handwrittenTags: ['Local view', 'Easy outing', 'Morning'], duration: '1–2 hours', costType: 'free', bestTime: 'Early morning', ...missingPhoto },
