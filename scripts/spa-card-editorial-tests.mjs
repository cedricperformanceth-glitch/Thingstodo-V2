...
const placeDraft = {
  shortDescription: 'A riverside café for coffee and a light meal, with seating beside the Mekong when you want an easy pause during the day.',
...
promotionalDraft.shortDescription = 'The best hidden-gem café beside the Mekong, perfect for anyone looking for coffee and a light meal during the day.';
...
badEvidence.evidenceRefs.shortDescription = ['not-a-real-fact'];
...
const activityDraft = {
  shortDescription: 'A guided paddle on the Mekong that gives you a slower view of the river, timed for the softer light of late afternoon and sunset.',
  handwrittenTags: ['Mekong', 'Slow paddle', 'Sunset'],
  duration: '2-3 hrs',
  costType: 'paid',
  bestTime: 'late afternoon',
  evidenceRefs: {
    shortDescription: ['a-action', 'a-time'],
