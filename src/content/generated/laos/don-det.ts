...
const data = {
  "city": {
    ...
    "exploreBoard": {
      ...
      "featuredThingIds": [
        ...
        "thing-li-phi-falls",
        "thing-irrawaddy-dolphin-viewpoint"
      ]
    },
    "media": {
      "hero": {
  ...
  "things": [
    ...
    },
    {
      ...
      "shortDescription": "A historic crossing on the route between Don Det and Don Khon.",
      "longDescription": "A landmark stop on the island route.",
      "isLandmark": true,
      "media": {
        "hero": {
          "stamps": [],
