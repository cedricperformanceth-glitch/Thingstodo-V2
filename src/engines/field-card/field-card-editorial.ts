...
export const getEditorialFaq = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.faq ?? faq[id];
export const getEditorialHero = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.hero ?? hero[id];
export const getEditorialMedia = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.media ?? mediaAdditions[id] ?? media[id];
export const getEditorialPractical = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.practical ?? practical[id];
export const getEditorialPrimaryStory = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.primaryStory ?? primaryStory[id];
export const getEditorialQuickRead = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.quickRead ?? quickRead[id];
export const getEditorialSeo = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.seo ?? seo[id];
export const getEditorialSources = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.sources ?? sources[id];
export const getEditorialSpa = (id: string) => isRemovedThingId(id) ? undefined : compact[id]?.spa ?? spa[id];
export const getEditorialSpaBestTime = (id: string) => isRemovedThingId(id) ? undefined : spaBestTime[id];
export const getEditorialSpaDescription = (id: string) => isRemovedThingId(id) ? undefined : spaDescription[id];
export const getEditorialSpaGettingThere = (id: string) => isRemovedThingId(id) ? undefined : spaGettingThere[id];
export const getEditorialThingName = (id: string) => isRemovedThingId(id) ? undefined : thingDisplayName[id];

export const getEditorialSecondaryStory = (id: string) => {
  if (isRemovedThingId(id)) return { hasOverride: false, value: undefined };
